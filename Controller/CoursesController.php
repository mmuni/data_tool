 ...
 */
	public function add() {
		...
		$courseProgrammes = $this->Course->CourseProgramme->find('list');
		$modules = $this->Course->Module->find('list');
		$applications = $this->Course->Application->find('list');
		$this->set(compact('courseTypes', 'courseProgrammes', 'modules', 'applications'));
	}
