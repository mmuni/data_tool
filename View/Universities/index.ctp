<div class="universities index">
	...
	<tr>
		...
		<td><?php echo h($university['University']['status']); ?>&nbsp;</td>
		<td><?php echo h($university['University']['date_started']); ?>&nbsp;</td>
		<td><?php echo h($university['University']['modified']); ?>&nbsp;</td>
		<td><?php echo h($university['University']['deleted']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $university['University']['id']), array(), __('Are you sure you want to delete # %s?', $university['University']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
